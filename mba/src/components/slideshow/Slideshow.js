...
import im from "C:/Users/priya/Desktop/frontend_dev/mba/src/components/div/images/akam-300x203-1.jpg"
      ...
      {items.map((item, index) => (
        <Carousel.Item key={index}>
          ...
          <div className="slideshoe-akam">
            ...
            <a href="http://anemiamuktbharatelearning.org/">Anemia Mukt Bharat E-Training Module</a>
